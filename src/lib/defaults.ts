...
export const DEFAULT_DEMAND_PRODUCTS: DemandProduct[] = [
  ...
  { id: "cut-breast-bone-in", category: "cuts", name: "Breast (bone-in)", unit: "kg" },
  { id: "cut-breast-boneless", category: "cuts", name: "Breast (boneless)", unit: "kg" },
  { id: "cut-whole-leg", category: "cuts", name: "Whole Leg", unit: "kg" },
  { id: "cut-drumstick", category: "cuts", name: "Drumstick", unit: "kg" },
  { id: "cut-thigh-bone-in", category: "cuts", name: "Thigh (bone-in)", unit: "kg" },
  { id: "cut-wings", category: "cuts", name: "Wings", unit: "kg" },
  { id: "cut-back-neck", category: "cuts", name: "Back & Neck", unit: "kg" },
  { id: "cut-giblets", category: "cuts", name: "Giblets", unit: "kg" },
  { id: "cut-trim-mince", category: "cuts", name: "Trim / Mince", unit: "kg" },
  { id: "cut-marinated", category: "cuts", name: "Marinated", unit: "kg" },
  { id: "fpp-nuggets", category: "fpp", name: "Nuggets", yieldPct: 0.2, unit: "kg" },
  { id: "fpp-burgers-patties", category: "fpp", name: "Burgers / Patties", yieldPct: 0.15, unit: "kg" },
  { id: "fpp-strips-tenders", category: "fpp", name: "Strips / Tenders", yieldPct: 0.2, unit: "kg" },
  { id: "fpp-shawarma", category: "fpp", name: "Shawarma", yieldPct: 0.15, unit: "kg" },
  { id: "fpp-marinated-pieces", category: "fpp", name: "Marinated Pieces", yieldPct: 0.15, unit: "kg" },
  { id: "fpp-other", category: "fpp", name: "Other FPP", yieldPct: 0.15, unit: "kg" },
